...
class PilihOngkir extends StatefulWidget {
  final double totalJual; // Tambahkan totalJual sebagai parameter

  const PilihOngkir({Key? key, required this.totalJual}) : super(key: key);

  @override
  State<PilihOngkir> createState() => _PilihOngkirState();
}

class _PilihOngkirState extends State<PilihOngkir> {
  var strKey = '8ed728cc9b50af50c4d21ef57d844277';
  var strKotaAsal;
  var strKotaTujuan;
  var strBerat;
  var strEkspedisi;
  List<dynamic> kotaList = []; // Initialize with an empty list
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => DetailPage(
                                      ...
                                      kurir: strEkspedisi,
                                      totalJual: widget
                                          .totalJual, // Kirim totalJual ke DetailPage
                                    )),
                          );
                        }
                      },
